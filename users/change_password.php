            ...
            <div class="white-box">
                <form class="form-horizontal form-material" id="loginform" action="" method="post">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                        <div class="col-xs-12">
                            <input class="form-control" type="text" required="" placeholder="Confirm Password" name="c_password">
                        </div>
                    </div>
                    <div class="form-group text-center m-t-20">
                        <div class="col-xs-12">
                            <button class="btn btn-primary btn-lg btn-block text-uppercase waves-effect waves-light" type="submit" name="reset">Change</button>
                        </div>
                    </div>
                </form>
            </div>
...
if (isset($_POST['reset']) && ($password==$c_password)) {
...
$sql=("UPDATE  tbl_users SET password='$param_password' WHERE email='$session_name' ");
