            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-6 ol-md-6 col-xs-12">
                        <div class="white-box">
                            <h3 class="box-title">Upload Your Passport</h3>
                         ...
                         <!--    <button class="btn btn-block btn-primary" name="submit" value="Upload">Click To Upload</button>
                             -->
                          <button type="submit" class="btn btn-success waves-effect waves-light m-r-10"  name="submit" value="Upload">UPLOAD NEW PASSPORT</button>
