...
if (isset($_POST['submit']))
{
    ...
    $allowed_file_types = array('.odt','.docx','.rtf','.pdf');  
    ...
    {   
        ...
        if (file_exists("letters/" . $newfilename))
        {
        ...
        if (move_uploaded_file($_FILES["file"]["tmp_name"], "letters/" . $newfilename)){
            $insert = $mysqli->query("INSERT into tbl_letters (file_name, uploaded_on, email) VALUES ('".$newfilename."', NOW(),'".$session_name."')");
            if($insert){
...
<div class="row">
                    <div class="col-lg-12">
                        <div class="white-box">
                            <h3 class="m-b-0 box-title">UPDATE/ CHANGE YOUR DISPLAY PICTURES </h3>
                        
                            <div class="row">
                            
                                <div class="col-lg-2 col-sm-4 col-xs-12">
                                    <button class="btn btn-block btn-info">UPDATE DP</button>
                                </div>
